...
Spell Property drainHealthSpell Auto        ; The spell that applied to drain victims
...
Spell Property energyForMagickaToggleSpell Auto     ; The spell that toggles energy for magicka perk. Used to resolve a race condition
Perk Property energyForMagickaPerk Auto             ; The perk that reduces magicka cost to 0 and gets detected for causing energy drain
